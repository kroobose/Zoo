...
def crop_facescrub(facescrub_root, facescrub_lms_file, target_folder):
    ...
    with open(facescrub_lms_file) as facescrub_lms_file_buf:
...
if __name__ == '__main__':
    facescrub_root = '/workspace/dataset/evaluation/LFW/data'
    facescrub_lms_file = '/workspace/dataset/evaluation/LFW/lfw_face_info.txt'
    target_folder = '/workspace/dataset/evaluation/LFW/crop_data'
